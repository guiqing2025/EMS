...
def quote_detail_dict(db: Session, quote: QuoteOrder) -> dict:
    ...
    return {
        ...
        "inquiry_id": getattr(quote, "inquiry_id", None),
        "customer_id": getattr(quote, "customer_id", None),
        "quote_kind": getattr(quote, "quote_kind", None) or "cost",
        "supplier_name": getattr(quote, "supplier_name", None) or "",
        "supplier_cost": float(getattr(quote, "supplier_cost", 0) or 0),
        "sell_price": float(getattr(quote, "sell_price", 0) or 0),
