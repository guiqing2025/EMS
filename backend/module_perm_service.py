...
PAGE_CATALOG: list[dict[str, str]] = [
    ...
    {"key": "eng-docs", "group": "前端工程", "title": "工程资料"},
    {"key": "eng-control", "group": "前端工程", "title": "物料管制"},
    {"key": "eng-sub", "group": "前端工程", "title": "替代料"},
    {"key": "eng-process", "group": "前端工程", "title": "工序对照"},
    {"key": "plan-home", "group": "计划", "title": "计划首页"},
    {"key": "plan-mc-kitting", "group": "计划", "title": "MC齐套运算"},
    {"key": "plan-pmc-schedule", "group": "计划", "title": "PMC排产"},
